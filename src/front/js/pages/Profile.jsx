...
export const Profile = () => {
    ...
    return (
        <div className="p-3 d-flex justify-content-center bg-dark vh-100">
                            ...
                            <div className="modal fade " id="exampleModal" tabIndex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                <div className="modal-dialog modal-xl">
                                    ...
                                    <div className=" modal-body bg-dark mx-0 row ">
                                        <button type="button" className="btn btn-avatar btn-dark col-2 my-1 p-2 rounded-circle" onClick={()=> handleAvatar(1)} data-bs-toggle="modal" data-bs-target="#exampleModal">
                                        ...
                                        <button type="button" className="btn btn-avatar btn-dark col-2 my-1 p-2 rounded-circle" onClick={()=> handleAvatar(2)} data-bs-toggle="modal" data-bs-target="#exampleModal">
                                        ...
                                        <button type="button" className="btn btn-avatar btn-dark col-2 my-1 p-2 rounded-circle" onClick={()=> handleAvatar(3)} data-bs-toggle="modal" data-bs-target="#exampleModal">
                                        ...
                                        <button type="button" className="btn btn-avatar btn-dark col-2 my-1 p-2 rounded-circle" onClick={()=> handleAvatar(4)} data-bs-toggle="modal" data-bs-target="#exampleModal">
                                        ...
                                        <button type="button" className="btn btn-avatar btn-dark col-2 my-1 p-2 rounded-circle" onClick={()=> handleAvatar(5)} data-bs-toggle="modal" data-bs-target="#exampleModal">
                                        ...
                                        <button type="button" className="btn btn-avatar btn-dark col-2 my-1 p-2 rounded-circle" onClick={()=> handleAvatar(6)} data-bs-toggle="modal" data-bs-target="#exampleModal">
                                        ...
                                        <button type="button" className="btn btn-avatar btn-dark col-2 my-1 p-2 rounded-circle" onClick={()=> handleAvatar(7)} data-bs-toggle="modal" data-bs-target="#exampleModal">
                                        ...
                                        <button type="button" className="btn btn-avatar btn-dark col-2 my-1 p-2 rounded-circle" onClick={()=> handleAvatar(8)} data-bs-toggle="modal" data-bs-target="#exampleModal">
                                        ...
                                        <button type="button" className="btn btn-avatar btn-dark col-2 my-1 p-2 rounded-circle" onClick={()=> handleAvatar(9)} data-bs-toggle="modal" data-bs-target="#exampleModal">
                                        ...
                                        <button type="button" className="btn btn-avatar btn-dark col-2 my-1 p-2 rounded-circle" onClick={()=> handleAvatar(10)} data-bs-toggle="modal" data-bs-target="#exampleModal">
                                        ...
                                        <button type="button" className="btn btn-avatar btn-dark col-2 my-1 p-2 rounded-circle " onClick={()=> handleAvatar(11)} data-bs-toggle="modal" data-bs-target="#exampleModal">
                                        ...
                                        <button type="button" className="btn btn-avatar btn-dark col-2 my-1 p-2 rounded-circle  " onClick={()=> handleAvatar(12)} data-bs-toggle="modal" data-bs-target="#exampleModal">
